...
Install the skills in a consuming project, create requirements, and use those
requirements to produce detailed designs. The examples below use Claude Code.
...
| Python 3 | Run the bundled diagram renderer; it uses the Python standard library. |
...
path with an existing project. If either skill is already installed, follow
